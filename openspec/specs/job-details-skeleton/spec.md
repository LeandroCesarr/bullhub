# Spec: JobDetails Skeleton

## Purpose

Defines the loading skeleton displayed in the JobDetails page while job data is being fetched for the first time, replacing the plain "Loading ..." text with a structured placeholder that mirrors the real page layout.
