...
Defines management actions (pause, resume, drain) available on a single queue from the Queue Detail page, including the backend endpoints and the confirmation UX for the destructive drain action.
