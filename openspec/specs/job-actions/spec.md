...
Defines the behavior of job action controls (retry, cancel, promote) available on the Job Details page, including the backend endpoints that support them and the shared `ActionButton` component's loading and disabled states.
